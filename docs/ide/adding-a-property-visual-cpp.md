...
ms.locfileid: "81751188"
---
# <a name="add-a-property"></a>プロパティの追加
...
- **実装型**
  ...
  |**メンバー変数**|メンバー変数として追加されるプロパティを指定します。 カスタム プロパティやほとんどのストック プロパティをメンバー変数として追加することができます。 プロパティ 、、`hWnd`および`Text`プロパティに`Caption`Member**変数**を指定することはできません。<br /><br /> **[変数名]** と **[通知関数]** の下に既定の名前を提供します。 この名前は編集できます。|
...
- **パラメーター属性**
  ...
  ATL インターフェイスのみ。 **[パラメーター名**] で指定したパラメーター`in`が`out`、両方、または none のいずれであるかを設定します。
