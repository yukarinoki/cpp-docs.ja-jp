...
![強調表示されているマクロ。](../ide/media/hint-squiggle-and-actions.png "ヒントの波線とクイック アクション")
...
![[Macros in Skipped Browsing Regions]\(スキップされた参照領域のマクロ\) オプション。](../ide/media/skipped-regions-squiggle-option.png "スキップされた領域の波線オプション。")
