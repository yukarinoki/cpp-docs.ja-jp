---
description: 詳細については、「ファイル処理」を参照してください。
title: ファイル処理
ms.date: 11/04/2016
f1_keywords:
- c.files
...
|ルーチンによって返される値|使用|
|-------------|---------|
|[_fdopen、_wfdopen](../c-runtime-library/reference/fdopen-wfdopen.md)|ストリームを前回下位入出力で開いたファイルに関連付け、オープン ストリームへのポインターを返します。|
