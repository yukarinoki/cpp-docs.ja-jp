---
description: '詳細については、次を参照してください: _daylight、_dstbias、_timezone、および _tzname'
...
ms.locfileid: "97258783"
---
# <a name="_daylight-_dstbias-_timezone-and-_tzname"></a>_daylight、_dstbias、_timezone、および _tzname
