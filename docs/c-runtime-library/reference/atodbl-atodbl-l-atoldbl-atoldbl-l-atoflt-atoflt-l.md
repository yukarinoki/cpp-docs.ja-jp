---
description: 詳細については、_atodbl、_atodbl_l、_atoldbl、_atoldbl_l、_atoflt、_atoflt_l を参照してください。
...
処理が正常に終了した場合は 0 を返します。 考えられるエラーコードは、ヘッダーファイルで定義されている **_UNDERFLOW** または **_OVERFLOW** です \<math.h> 。
