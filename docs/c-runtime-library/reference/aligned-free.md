---
description: '詳細については、次を参照してください: _aligned_free'
title: _aligned_free
ms.date: 4/2/2020
api_name:
- _aligned_free
...
**_aligned_free** はとマークされてい `__declspec(noalias)` ます。つまり、関数はグローバル変数を変更しないことが保証されます。 詳細については、「[noalias](../../cpp/noalias.md)」を参照してください。
