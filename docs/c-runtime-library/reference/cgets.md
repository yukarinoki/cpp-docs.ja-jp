...
ms.locfileid: "32393252"
---
# <a name="cgets"></a>cgets

この POSIX 関数は非推奨とされます。 代わりに ISO C++ 準拠の [_cgets](../../c-runtime-library/cgets-cgetws.md) またはセキュリティが強化された [_cgets_s](cgets-s-cgetws-s.md) を使用してください。
