---
description: '詳細については、次を参照してください: strdup、wcsdup'
title: strdup、wcsdup
ms.date: 12/16/2019
api_name:
- wcsdup
...
ms.locfileid: "97181697"
---
# <a name="strdup-wcsdup"></a>strdup、wcsdup

Microsoft が実装した POSIX 関数名 `strdup` と `wcsdup` は、 [_strdup および _wcsdup](strdup-wcsdup-mbsdup.md) 関数の非推奨のエイリアスです。 既定では、 [コンパイラの警告 (レベル 3) C4996](../../error-messages/compiler-warnings/compiler-warning-level-3-c4996.md)が生成されます。 これらの名前は、実装固有の名前の標準 C 規則に従っていないため、非推奨とされます。 ただし、関数は引き続きサポートされます。
