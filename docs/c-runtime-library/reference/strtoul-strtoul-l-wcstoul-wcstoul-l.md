---
description: '詳細については、次を参照してください: strtoul、_strtoul_l、wcstoul、_wcstoul_l'
...
これらの各関数は、入力文字列 *Strsource* をに変換し **`unsigned long`** ます。
