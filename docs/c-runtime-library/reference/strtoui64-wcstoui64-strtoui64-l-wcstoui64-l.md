---
description: '詳細については、次を参照してください: _strtoui64、_wcstoui64、_strtoui64_l、_wcstoui64_l'
...
**_Strtoui64** 関数は、 *strsource* をに変換 **`unsigned __int64`** します。 **_wcstoui64** は **_strtoui64** のワイド文字バージョンです。 *Strsource* 引数はワイド文字列です。 それ以外では、これらの関数の動作は同じです。
