...
|type 文字|引数|[出力形式]|
|--------------------|--------------|-------------------|
|**c**|Character|`printf` 関数で使用する場合は 1 バイト文字を指定し、`wprintf` 関数で使用する場合はワイド文字を指定します。|
|**C**|Character|`printf` 関数で使用する場合はワイド文字を指定し、`wprintf` 関数で使用する場合は 1 バイト文字を指定します。|
|**d**|整数|符号付き 10 進整数。|
|**i**|整数|符号付き 10 進整数。|
|**o**|整数|符号なし 8 進整数。|
|**u**|整数|符号なし 10 進整数。|
