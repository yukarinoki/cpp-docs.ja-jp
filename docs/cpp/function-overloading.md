...
|1 を設定します。Fraction 型の最初の引数を持つ候補関数|2 を設定します。候補関数を 2 番目の引数に変換できる型**int**|
|--------------------------------------------------------------------------|-----------------------------------------------------------------------------------|
...
|1 を設定します。候補の関数型を持つ最初の引数の**int**|2 を設定します。候補の関数型を持つ 2 つ目の引数の**int**|
|---------------------------------------------------------------------|----------------------------------------------------------------------|
...
クラス スコープが厳密に遵守されます。基底クラスで宣言された関数が関数と同じスコープにないため、派生クラスで宣言します。 派生クラスの関数が基底クラスの派生クラスの関数の仮想関数と同じ名前で宣言されている*オーバーライド*基底クラス関数。 詳細については、[仮想関数](../cpp/virtual-functions.md)を参照してください。
