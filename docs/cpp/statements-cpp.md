...
-   ステートメントのカテゴリ  
    ...
    -   [宣言ステートメント](http://msdn.microsoft.com/14538558-356f-450e-9e1e-3cd62ba952b9)します。 宣言は、プログラムに名前を導入します。 ([宣言と定義](declarations-and-definitions-cpp.md)宣言に関する詳細情報を提供します)。  
