---
title: ヘッダー ファイル (C++) |Microsoft Docs
ms.custom: ''
ms.date: 04/20/2018
ms.reviewer: ''
ms.suite: ''
...
通常、ヘッダー ファイルがある、 *guard*または **#pragma 1 回**ことがないに挿入した複数回、1 つの .cpp ファイルを確認するディレクティブ。 
...
名前空間 N {my_class クラス {パブリック: void do_something();};
