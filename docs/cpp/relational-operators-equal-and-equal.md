...
-   クラス型がない場合、**共用体**場合によっては、2 つのメンバーは分離されていないと、*アクセス指定子*など**パブリック**、**保護**、または**プライベート**、最後に宣言されたメンバーへのポインターがこの前に宣言されたメンバーへのポインターよりも大きい比較されます。  
  
-   2 つのメンバーで区切られている場合、*アクセス指定子*結果は定義されていません。  
  
-   クラス型の場合、**共用体**でさまざまなデータ メンバーへのポインター**共用体**比較結果が同じです。  
