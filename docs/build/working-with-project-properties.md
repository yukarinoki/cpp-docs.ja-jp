...
1. **[プロパティマネージャー]** ウィンドウを開きます。 (メニューバーで、[**表示** > **プロパティマネージャー**または**その他のウィンドウ** > **プロパティマネージャー**を**表示** > します)] を選択します。プロパティシート (名前の末尾が. user) のショートカットメニューを開き、 **[プロパティ]** を選択します。 そのプロパティ シートの **[プロパティ ページ]** ダイアログ ボックスが開きます。
