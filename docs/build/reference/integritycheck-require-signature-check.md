...
[整合性の署名のポータブル実行可能ファイル (PE) ファイルを強制](http://social.technet.microsoft.com/wiki/contents/articles/255.forced-integrity-signing-of-portable-executable-pe-files.aspx)
