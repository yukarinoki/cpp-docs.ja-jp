---
description: 詳細については、「/MD、/MT、/LD (Run-Time ライブラリを使用する)」を参照してください。
title: /MD、-MT、-LD (Run-Time ライブラリを使用)
ms.date: 07/17/2019
f1_keywords:
- /ld
- /mt
...
ランタイムライブラリのデバッグバージョンを使用する方法の詳細については、「 [C Run-Time ライブラリリファレンス](../../c-runtime-library/c-run-time-library-reference.md)」を参照してください。
