...
|[/FU](fu-name-forced-hash-using-file.md)|[#Using](../../preprocessor/hash-using-directive-cpp.md)ディレクティブに渡されたかのように、ファイル名を強制的に使用します。|
...
|[/GZ](gz-enable-stack-frame-run-time-error-checking.md)|非推奨になりました。 [/RTC1](rtc-run-time-error-checks.md)と同じです。|
