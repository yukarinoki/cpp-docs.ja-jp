...
>
> - Visual Studio 2017 バージョン 15.6 より前のバージョンでは、すべての変更に対してソリューションの .sdf ファイルまたは VC.db ファイルを削除します。
> - Visual Studio 2017 バージョン 15.6 以降: 新しいヒント ファイルを追加した後、ソリューションを閉じて再度開きます。
...
![強調表示されたマクロ。](media/hint-squiggle-and-actions.png "ヒント波線とクイックアクション")
...
![共通およびプロジェクト&#45;特定のヒントファイルディレクトリ。](media/hintfile.png "ヒントファイル")
