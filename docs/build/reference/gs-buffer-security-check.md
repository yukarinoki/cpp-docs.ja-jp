---
title: -GS (バッファー セキュリティ チェック) |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
2.  **プロパティ ページ**ダイアログ ボックスで、をクリックして、 **C/C++** フォルダー。  
  
3.  をクリックして、**コード生成**プロパティ ページ。  
  
4.  変更、**バッファー セキュリティ チェック**プロパティ。  
