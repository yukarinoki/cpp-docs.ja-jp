...
1. **[アクティブ ソリューション プラットフォーム]** ドロップダウン リストで、 **[\<新規…>]** オプションを選択して **[新しいソリューション プラットフォーム]** ダイアログ ボックスを開きます。
...
1. **[構成マネージャー]** ダイアログ ボックスの **[閉じる]** ボタンを選択し、 **[\<プロジェクト名> プロパティ ページ]** ダイアログ ボックスの **[OK]** ボタンを選択します。
