...
|**Grid**|レイアウトグリッドを作成します。 新しいコントロールは、グリッドに自動的に配置されます。|
...
- 目盛りの間隔を変更するには、メニュー**形式**ガイドの設定に移動し、  >  **Guide Settings**[**グリッドの間隔**] フィールドで、dlu の新しい幅と高さを指定します。
...
- レイアウトグリッドをオンまたはオフにするには、メニュー**形式**ガイドの設定に進んで、  >  **Guide Settings** **グリッド**ボタンをオンまたはオフにします。
...
- ガイドをオフにするには、メニュー**形式**ガイドの設定に関するページを参照  >  **Guide Settings**してください。 次に、[ **レイアウトガイド**] で [ **なし**] を選択します。
...
- コントロールのサイズを同じにするには、サイズを変更するコントロールを選択し、[メニュー**形式**] に同じサイズを設定し、[両方]、[高さ]、[幅] の  >  **Make Same Size**いずれかを選択します。 **Both** **Height** **Width**
...
- コントロールを均等にスペースに配置するには、再配置するコントロールを選択します。 メニューの書式を均等に**設定**  >  **Space Evenly**し、次のスペースの配置のいずれかを選択します。
...
- コントロールを中央に配置するには、配置を変更するコントロールを選択します。 ダイアログボックスの [メニューの**書式設定**] にアクセス  >  **Center In Dialog**して、次のいずれかの配置を選択します。
...
- プッシュボタンを配置するには、1つまたは複数のプッシュボタンを選択します。 **メニューの [**  >  **配置] ボタン**に移動し、次のいずれかの並べ替えを選択します。
   ...
   |**最終**|ダイアログボックスの下端に沿ってプッシュボタンを配置します。|
