...
ダイアログ ボックスを追加すると、コンボ ボックスを調整することができます。 ドロップダウン リスト ボックスのサイズを指定することもできます。 詳細については、[値コンボ ボックス コントロールを追加](../windows/adding-values-to-a-combo-box-control.md)を参照してください。
