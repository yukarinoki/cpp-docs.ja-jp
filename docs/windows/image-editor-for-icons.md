...
|**現在のアイコン/カーソルの画像の種類**|最初の9個の使用可能なカーソルまたはアイコンのイメージを一覧表示するサブメニューを開きます。 [その**他**] サブメニューの最後のコマンドは、[ [\<デバイス > イメージを開く] ダイアログボックス](../windows/open-device-image-dialog-box-image-editor-for-icons.md)を開きます。|
...
- **イメージエディター**のツールバーを表示または非表示にするには、[メニュー**ビュー** > **ツール**バー] にアクセスし、 **[イメージエディター]** を選択します。
...
このダイアログボックスにアクセスするには、**イメージエディター**を開き、[メニュー**イメージ** > **ツール**] にアクセスして、 **[テキストツール]** コマンドを選択します。
