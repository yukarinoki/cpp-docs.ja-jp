...
新しいグラフィカルリソースを作成するだけでなく、 [既存のイメージをインポート](../windows/how-to-copy-resources.md#import-and-export-resources) してプロジェクトに追加することもできます。 また、 [スタンドアロンのイメージ編集](./selecting-an-area-of-an-image-image-editor-for-icons.md)用にプロジェクトの一部ではないイメージを開いて編集することもできます。
...
|**パレットの読み込み**|[ **カラーパレットの読み込み** ] ダイアログボックスを開きます。これにより、以前に pal ファイルに保存されたパレットの色を読み込むことができます。|
|**パレットの保存**|パレットの色を pal ファイルに保存します。|
|**不透明な描画**|選択すると、現在の選択範囲が不透明になります。<br/><br/>オフにすると、現在の選択項目が透明になります。|
|**ツールバーエディター**|[ [新しいツールバーリソース] ダイアログボックス](./toolbar-editor.md)を開きます。|
|**グリッドの設定**|[ **グリッドの設定** ] ダイアログボックスを開きます。このダイアログボックスでは、イメージのグリッドを指定できます。|
|**新しいイメージの種類**|[ [新しい \<Device> イメージの種類] ダイアログボックス](./creating-an-icon-or-other-image-image-editor-for-icons.md)を開きます。<br/><br/>1つのアイコンリソースには、さまざまなサイズのイメージを複数含めることができます。また、ウィンドウの表示方法に応じて、適切なアイコンサイズを使用できます。 新しいデバイスの種類では、アイコンのサイズは変更されませんが、代わりにアイコン内に新しいイメージが作成されます。 アイコンおよびカーソルにのみ適用されます。|
|**現在のアイコン/カーソルの画像の種類**|最初の9個の使用可能なカーソルまたはアイコンのイメージを一覧表示するサブメニューを開きます。 [その **他**] サブメニューの最後のコマンドは、[ [イメージを開く \<Device> ] ダイアログボックス](./creating-an-icon-or-other-image-image-editor-for-icons.md)を開きます。|
...
[**イメージエディター** ] ツールバーで使用できるすべてのツールは、メニュー**イメージ**ツールからも使用でき  >  **Tools**ます。 [ **イメージエディター** ] ツールバーと **オプション** セレクターを使用するには、必要なツールまたはオプションを選択します。
...
- **イメージエディター**のツールバーを表示または非表示にするには、メニュー**ビュー**の [ツールバー] にアクセスし、  >  **Toolbars** [**イメージエディター**] を選択します。
...
このダイアログボックスにアクセスするには、**イメージエディター**を開き、[メニュー**イメージ**ツール] にアクセスして、[  >  **Tools****テキストツール**] を選択します。
