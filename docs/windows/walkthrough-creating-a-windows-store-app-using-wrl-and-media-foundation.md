...
-   `namespace`と`runtimeclass`属性、および`NTDDI_WIN8`[バージョン](http://msdn.microsoft.com/66ac5cf3-2230-44fd-aaf6-8013e4a4ae81)属性の値は WRL を使用するメディア ファンデーション コンポーネントの MIDL 定義の重要な部分です。  
