...
|プロパティ|説明|
|--------------------------|------------------------------------------|
|**Name**|シンボルの名前を表示します。<br/><br/>詳細については、[シンボル名の制限](../windows/symbol-name-restrictions.md)を参照してください。|
|**[値]**|シンボルの数値を表示します。<br/><br/>詳細については、[シンボル値の制限](../windows/symbol-value-restrictions.md)を参照してください。|
...
|**変更**|開く、**シンボルの変更**名前またはシンボルの値を変更することができます ダイアログ ボックス。<br/><br/>使用中のコントロールまたはリソースのシンボルを変更するには、対応するリソース エディターを使用する必要があります。 詳細については、[管理シンボル](../windows/changing-unassigned-symbols.md)を参照してください。|
