...
> [!TIP]
> [**リソースビュー** ] ウィンドウを開くには、メニュー **ビュー**  >  **の [その他のウィンドウ**] リソースビューに移動する  >  か、 **Ctrl** + **Shift** + **E** キーを押します。
...
- **リソースビュー** で、.rc ファイルを選択し、[ **Edit** resource] \ (リソースの追加 \) を使用して、  >  プロジェクトに追加するリソースの種類を選択します。
...
リソーススクリプトファイルを開いた状態で、[ファイル] [   >  **名前を付け \<*filename*> て保存**] にアクセスします。 場所を指定し、[ **OK]** を選択します。
