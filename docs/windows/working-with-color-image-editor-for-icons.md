...
## <a name="select-foreground-or-background-colors"></a>前景色または背景色を選択します。

を除き、**消しゴム**、ツールを**イメージ エディター**それぞれ、左または右マウス ボタンを押したときに現在前景色または背景色で描画をツールバー。

### <a name="to-select-a-foreground-color"></a>前景色を選択するには

マウスの左ボタンで使用色を選択、**色**パレット。

### <a name="to-select-a-background-color"></a>背景色を選択するには

マウスの右ボタンで使用色を選択、**色**パレット。

## <a name="filling-a-bounded-area-of-an-image-with-a-color"></a>イメージの内側の塗りつぶし
...
1. **イメージ エディター**ツールバー (または**イメージ**] メニューの [**ツール**コマンド) を選択、**入力**ツール。
...
## <a name="pick-up-a-color-from-an-image-to-use-elsewhere"></a>別の場所を使用するイメージから色を指定します。
...
## <a name="choose-a-transparent-or-opaque-background"></a>透明または不透明な背景を選択します。
...
## <a name="invert-the-colors-in-a-selection"></a>選択範囲の色を反転します。
...
## <a name="customize-or-change-colors"></a>カスタマイズまたは色を変更します。

**イメージ**エディターの**色**パレットは、標準の 16 色を最初に表示されます。 表示されている色は、独自のカスタム色を作成することもできます。 できます[を保存し、カスタマイズした色パレットを読み込む](../windows/saving-and-loading-different-color-palettes-image-editor-for-icons.md)します。
...
## <a name="save-and-load-different-color-palettes"></a>保存して別の色パレットを読み込む
...
## <a name="colors-window"></a>[色] ウィンドウ
