...
## <a name="getting-started"></a>作業の開始  
 ...
 使用する方法を示しています、 [IXMLHTTPRequest2](http://msdn.microsoft.com/bbc11c4a-aecf-4d6d-8275-3e852e309908)と[IXMLHTTPRequest2Callback](http://msdn.microsoft.com/aa4b3f4c-6e28-458b-be25-6cce8865fc71) UWP アプリで web サービスに HTTP GET および POST 要求を送信するタスクとのインターフェイス。  
