...
2.  **プロパティ** ウィンドウで、イメージの一部またはすべてのプロパティを変更します。  
    ...
    |**Height**|ピクセル単位で、イメージの高さを設定します。 既定値は、48 です。 イメージのトリミングまたは既存のイメージの下の空白を追加します。|  
    ...
    |**Width**|ピクセル単位で、イメージの幅を設定します。 ビットマップの既定値は、48 です。 イメージのトリミングまたは既存のイメージの右側に空白を追加します。|  
