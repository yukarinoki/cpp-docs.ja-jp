...
#### [シンボルの変更](changing-a-symbol-or-symbol-name-id.md)
...
##### [ダイアログ ボックスの作成](creating-a-new-dialog-box.md)
...
###### [コントロールのサイズ変更](sizing-individual-controls.md)
...
###### [ダイアログ ボックスのデザイン](testing-a-dialog-box.md)
