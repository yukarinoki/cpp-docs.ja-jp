...
## [Windows ランタイムおよびマネージド テンプレート (C++ コンポーネント拡張)](windows-runtime-and-managed-templates-cpp-component-extensions.md)
...
##### [Callback 関数 (WRL)](callback-function-wrl.md)
...
##### [Swap 関数 (WRL)](swap-function-wrl.md)
