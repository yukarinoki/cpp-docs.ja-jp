---
description: 詳細については、「Visual C++ でのデプロイ」を参照してください。
title: Visual C++ での配置
ms.date: 05/11/2018
helpviewer_keywords:
...
- *再頒布可能なマージモジュール* (.msm ファイル)。特定のライブラリを配置するために使用できます。また、アプリケーションの Windows インストーラー (.msi) ファイルに含めることができます。
