...
## <a name="create-new-toolbars"></a>ツールバーの新規作成します。
...
## <a name="convert-bitmaps-to-toolbar-resources"></a>ビットマップからツールバーのリソースに変換する
...
## <a name="create-move-and-edit-toolbar-buttons"></a>ツールバー ボタンを作成、移動、編集する
