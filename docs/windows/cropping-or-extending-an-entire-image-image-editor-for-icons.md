...
1.  イメージ全体を選択します。  
     ...
     イメージの一部が現在選択されているイメージ全体を選択する場合は、現在の選択範囲の境界線の外側にあるイメージをクリックします。  
  
2.  イメージが必要なサイズまでは、サイズ変更ハンドルをドラッグします。  
  
 通常、イメージ エディターは、トリミングまたはサイズ変更ハンドルを移動してサイズを変更するときに、イメージを拡大します。 押しながら場合、 **Shift**イメージ エディターのサイズ変更ハンドルを移動すると、キー[縮小または拡大](../windows/shrinking-or-stretching-an-entire-image-image-editor-for-icons.md)イメージ。  
