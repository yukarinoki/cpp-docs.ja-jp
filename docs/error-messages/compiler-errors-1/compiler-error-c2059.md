---
title: コンパイラ エラー C2059 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
メンバー テンプレート クラスまたはクラスの外側の関数を定義する場合は、C2059 も取得できます。 詳しくは、次を参照してください。[サポート技術情報記事 241949](http://support.microsoft.com/kb/241949)します。
