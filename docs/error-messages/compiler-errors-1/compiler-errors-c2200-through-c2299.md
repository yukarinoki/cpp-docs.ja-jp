...
|[コンパイラ エラー C2201](compiler-error-c2201.md)|'*識別子*': エクスポート/インポートするためには外部リンケージがあります。|
|コンパイラ エラー C2202|'*関数*': 値を返さないコントロール パスのすべて|
|[コンパイラ エラー C2203](compiler-error-c2203.md)|削除演算子は配列の境界を指定できません|
|[コンパイラ エラー C2204](compiler-error-c2204.md)|'*型*': 型の定義のかっこ内が見つかりませんでした|
|[コンパイラ エラー C2205](compiler-error-c2205.md)|'*識別子*': ブロック スコープを持つ外部変数を初期化できません|
|[コンパイラ エラー C2206](compiler-error-c2206.md)|'*関数*': typedef は関数の定義には使用できません|
|[コンパイラ エラー C2207](compiler-error-c2207.md)|'*メンバー*': クラス テンプレートのメンバーは、関数の型を取得できません|
...
|コンパイラ エラー C2211|パブリック デストラクターを持つ ref クラスから派生した ref クラスで非仮想デストラクターがパブリックでもある必要があります。|
...
|コンパイラ エラー C2214|'void' に基づくポインターの使用を要求する: >|
|コンパイラ エラー C2215|'*キーワード*' では使用できません '//ARCH:SSE '|
|[コンパイラ エラー C2216](compiler-error-c2216.md)|'*keyword1*'では使用できません'*keyword2*'|
...
|[コンパイラ エラー C2219](compiler-error-c2219.md)|構文エラー: 型修飾子は、後にある必要があります ' *'|
...
|[コンパイラ エラー C2223](compiler-error-c2223.md)|左の '->*識別子*' 構造体/共用体をポイントする必要があります|
|[コンパイラ エラー C2224](compiler-error-c2224.md)|左の '。*識別子*' 構造体/共用体の型である必要があります|
|コンパイラ エラー C2225|互換性のために残されています。|
|[コンパイラ エラー C2226](compiler-error-c2226.md)|構文エラー: 予期しない型 '*型*'|
|[コンパイラ エラー C2227](compiler-error-c2227.md)|左の '->*識別子*' クラス、構造体、共用体、ジェネリック型をポイントする必要があります|
|[コンパイラ エラー C2228](compiler-error-c2228.md)|左の '。*識別子*' クラス/構造体/共用体があります。|
|[コンパイラ エラー C2229](compiler-error-c2229.md)|クラス/構造体/共用体 '*型*' が無効なサイズが 0 の配列|
...
|[コンパイラ エラー C2267](compiler-error-c2267.md)|'*関数*': ブロック スコープを持つ静的関数は無効です|
