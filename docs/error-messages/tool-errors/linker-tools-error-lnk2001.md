...
-  ツール&#124;オプション&#124;プロジェクト&#124;vc++ ディレクトリ ダイアログの ライブラリ ファイルの選択 では、ライブラリの検索順序を変更することができます。 プロジェクトのプロパティ ページ ダイアログ ボックスで リンカー フォルダーでは、期限切れの可能性があるパスもあります。  
