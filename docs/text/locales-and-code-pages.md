---
description: 詳細については、「ロケールとコードページ」を参照してください。
title: ロケールとコード ページ
ms.date: 11/04/2016
helpviewer_keywords:
...
C のランタイム関数 `setlocale` は、現在のプログラムのロケール情報の一部または全部の設定、変更、および問い合わせが可能です。 [_Wsetlocale](../c-runtime-library/reference/setlocale-wsetlocale.md)ルーチンは、のワイド文字バージョンです `setlocale` 。の引数と戻り値は `_wsetlocale` ワイド文字列です。

## <a name="see-also"></a>関連項目

[Unicode と MBCS](../text/unicode-and-mbcs.md)<br/>
[文字セットの移植性の利点](../text/benefits-of-character-set-portability.md)
