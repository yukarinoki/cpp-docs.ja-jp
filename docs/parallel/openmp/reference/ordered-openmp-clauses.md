---
title: (OpenMP 句) を順序付けられた |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
ms.locfileid: "46419452"
---
# <a name="ordered-openmp-clauses"></a>ordered (OpenMP 句)

並列で必要な[の](../../../parallel/openmp/reference/for-openmp.md)ステートメント場合、[注文](../../../parallel/openmp/reference/ordered-openmp-directives.md)ディレクティブが、ループ内で使用されます。
...
`ordered` 適用されます、[の](../../../parallel/openmp/reference/for-openmp.md)ディレクティブ。
