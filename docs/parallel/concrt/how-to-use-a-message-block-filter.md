...
## <a name="example-count_primes-function"></a>例: count_primes 関数
...
## <a name="example-count_primes_filter-function"></a>例: count_primes_filter 関数
...
## <a name="example-finished-message-block-filter-code-sample"></a>例: 完成したメッセージブロックフィルターのコードサンプル
