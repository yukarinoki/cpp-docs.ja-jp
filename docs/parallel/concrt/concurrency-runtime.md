...
|[Windows ランタイムアプリのサンプル](https://docs.microsoft.com/samples/browse/?languages=cpp&expanded=windows&products=windows-uwp)|Windows ランタイム用のダウンロード可能なコードサンプルとデモアプリが含まれています。|
