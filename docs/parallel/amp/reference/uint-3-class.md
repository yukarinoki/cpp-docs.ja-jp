...
ms.locfileid: "97325798"
---
# <a name="uint_3-class"></a>uint_3 クラス
...
|名前|説明|
|----------|-----------------|
|[uint_3 コンストラクター](#ctor)|オーバーロードされます。 既定のコンストラクター。すべての要素を 0 で初期化します。|
...
## <a name="size"></a><a name="uint_3__size"></a> 幅
