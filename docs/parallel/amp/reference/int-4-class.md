...
ms.locfileid: "97327664"
---
# <a name="int_4-class"></a>int_4 クラス
...
|名前|説明|
|----------|-----------------|
|[int_4 コンストラクター](#ctor)|オーバーロードされます。 既定のコンストラクター。すべての要素を 0 で初期化します。|
...
## <a name="size"></a><a name="int_4__size"></a> 幅
