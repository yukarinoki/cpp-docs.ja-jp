---
description: '詳細情報: Concurrency:: graphics 名前空間関数'
...
## <a name="copy-function-concurrencygraphics-namespace"></a><a name="copy"></a> copy 関数 (Concurrency:: graphics 名前空間)
...
## <a name="copy_async-function-concurrencygraphics-namespace"></a><a name="copy_async"></a> copy_async 関数 (Concurrency:: graphics 名前空間)
