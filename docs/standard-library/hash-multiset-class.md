...
コンテナーの要素のハッシュと順序付けに使用される関数オブジェクトを含む、hash_multiset template パラメーターの*特徴*を返します。
...
コンテナーの要素をハッシュおよび順序付けするために使用される関数オブジェクトを含む、hash_multiset template パラメーターの*特徴*を返します。
