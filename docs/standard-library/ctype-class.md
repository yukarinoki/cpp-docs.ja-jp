...
- 値に変換する***ch***型の`CharType`型の値に**char**式を使用 (`char`) **ch**します。

- 値に変換する***バイト***型の**char**型の値に`CharType`式**CharType** (**バイト**)。

その他のすべての操作に対して実行される**char**明示的な特殊化と同じ方法で値**ctype**<`char`>。
...
*maskVal*文字がテストするのには、マスクの値。

*ch*属性をテストする文字。

*最初*属性を分類する範囲の最初の文字へのポインター。

*最後*属性を分類する範囲の最後の文字の直後の文字へのポインター。

*dest*の各文字の属性を特徴付けるマスク値が格納される配列の先頭へのポインター。
...
*既定*文字型のメンバー関数によって割り当てられる既定値`CharType`型の対応する文字を持たない**char**します。

*最初*変換される文字の範囲の最初の文字へのポインター。

*最後*変換される文字の範囲の最後の文字の直後の文字へのポインター。

*dest*型の最初の文字への const ポインター **char**変換後の文字の範囲を格納する宛先範囲。
...
*maskVal*文字により照合されるマスク値。

*最初*のスキャン範囲の最初の文字へのポインター。

*最後*のスキャン範囲の最後の文字の直後の文字へのポインター。
...
*最初*がケースには変換される文字の範囲の最初の文字へのポインター。

*最後*がケースには変換される文字の範囲の最後の文字の直後の文字へのポインター。
...
*最後*がケースには変換される文字の範囲の最後の文字の直後に続く文字へのポインター。
...
*バイト*型の文字**char**でネイティブ文字セットに変換します。

*最初*変換される文字の範囲の最初の文字へのポインター。

*最後*変換される文字の範囲の最後の文字の直後の文字へのポインター。

*dest*型の最初の文字へのポインター`CharType`変換後の文字の範囲を格納する宛先範囲。
...
*バイト*変換するネイティブ文字の char 型の文字セットします。
