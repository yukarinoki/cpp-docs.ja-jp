...
通貨入力フィールドの形式は、有効な呼び出し[use_facet](../standard-library/locale-functions.md#use_facet)**fac** [locale facet](../standard-library/locale-class.md#facet_class)  <  [moneypunct](../standard-library/moneypunct-class.md) \< **CharType**, **intl**>> ( **iosbase. flags**) によって返されるロケールファセット fac. によって決定されます。 [getloc](../standard-library/ios-base-class.md#getloc))。
...
任意の余白は、書式パターンの末尾以外に出現する場合、**money_base::space** と等しい要素が書式パターンに出現しているときに一致します。 それ以外の場合、内部の余白は一致しません。 *ch* [use_facet](../standard-library/locale-functions.md#use_facet)  <  [Ctype](../standard-library/ctype-class.md) \< **CharType**> > ( **iosbase. flags**を use_facet 場合、要素 ch は空白と見なされます。 [getloc](../standard-library/ios-base-class.md#getloc))。 [is](../standard-library/ctype-class.md#is)( **ctype_base:: space**, *ch*) がです **`true`** 。
