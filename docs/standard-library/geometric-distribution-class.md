---
title: geometric_distribution クラス
ms.date: 11/04/2016
f1_keywords:
...
クラス テンプレートは、幾何分布を持つユーザー指定の整数型の値を生成する分布を表します。 次の表は、個々のメンバーに関する記事にリンクしています。
...
## <a name="geometric_distributionparam_type"></a><a name="param_type"></a>geometric_distribution::pアラム_タイプ
