...
ステータス バー コントロールを使用することができます ([CStatusBarCtrl](../mfc/reference/cstatusbarctrl-class.md)) さまざまな種類のアプリケーションに関する状態情報を反映するコントロール ウィンドウを作成します。 ステータス ウィンドウは、情報の 1 つ以上の種類を表示する部分に分割できます。
