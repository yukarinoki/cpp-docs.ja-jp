...
これで、従来の Scribble 1.0 MFC サンプルを、リボン デザイナーを使用するように修正しました。 次に「[パート 2](../mfc/walkthrough-updating-the-mfc-scribble-application-part-2.md)です。

## <a name="see-also"></a>関連項目

[チュートリアル](../mfc/walkthroughs-mfc.md)  
[チュートリアル: MFC Scribble アプリケーション (パート 2) の更新](../mfc/walkthrough-updating-the-mfc-scribble-application-part-2.md)  
