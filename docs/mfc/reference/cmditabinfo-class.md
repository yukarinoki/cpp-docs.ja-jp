---
title: CMDITabInfo クラス |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="remarks"></a>Remarks  
 ...
 STYLE_3D_ONENOTE  
 Microsoft OneNote スタイル。  
  
 STYLE_3D_VS2005  
 Microsoft Visual Studio 2005 スタイル。  
  
 STYLE_3D_SCROLLED  
 四角形 タブのラベルの 3D スタイル。  
  
 STYLE_FLAT_SHARED_HORZ_SCROLL  
 共有の水平スクロール バーでのフラット スタイル。  
  
 STYLE_3D_ROUNDED_SCROLL  
 Round タブのラベルの 3D スタイル。  
