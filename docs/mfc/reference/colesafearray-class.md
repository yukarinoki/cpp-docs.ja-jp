...
### <a name="parameters"></a>パラメーター  
 *varSrc*  
 `VARIANT` オブジェクト。 *VarSrc*パラメーターが必要、 [VARTYPE](http://msdn.microsoft.com/317b911b-1805-402d-a9cb-159546bc88b4)vt_array です。  
