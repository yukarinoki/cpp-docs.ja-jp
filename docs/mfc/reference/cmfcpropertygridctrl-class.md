...
|[CMFCPropertyGridCtrl:: get_accHelp](#get_acchelp)|オブジェクトの`Help`プロパティ文字列を取得するために、フレームワークによって呼び出されます。 ( [CWnd:: get_accHelp](../../mfc/reference/cwnd-class.md#get_acchelp)をオーバーライドします)。|
