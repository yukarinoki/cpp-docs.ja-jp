...
### <a name="remarks"></a>Remarks  
 ...
 場合*lpStgMedium*-> *tymed*は**TYMED_NULL**、 **STGMEDIUM**割り当てられている必要があります、で指定された設定*lpFormatEtc tymed]-> [* です。 ない場合**TYMED_NULL**、 **STGMEDIUM**のデータが配置を入力する必要があります。  
