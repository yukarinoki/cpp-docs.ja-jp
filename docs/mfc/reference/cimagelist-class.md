...
|[CImageList::D eleteTempMap](#deletetempmap)|[CWinApp](../../mfc/reference/cwinapp-class.md) `CImageList` によって作成された一時オブジェクトを削除するために、CWinApp idle time ハンドラーによって呼び出され `FromHandle` ます。|
