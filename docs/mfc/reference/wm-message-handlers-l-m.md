---
title: 'Wm _ で始まるメッセージ ハンドラー: L-M |Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|マップ エントリ|関数プロトタイプ|
|---------------|------------------------|
|ON_WM_LBUTTONDBLCLK()|afx_msg void[離し](../../mfc/reference/cwnd-class.md#onlbuttondblclk)(UINT, CPoint)。|
