...
*uStateEx*\
から項目の拡張された状態。 詳細については、 `uStateEx` [TVITEMEX](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) 構造体のメンバーを参照してください。
...
## <a name="ctreectrlsettooltips"></a><a name="settooltips"></a> CTreeCtrl:: SetToolTips ヒント
