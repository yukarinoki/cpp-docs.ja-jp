---
title: CMFCPrintPreviewToolBar クラス
ms.date: 11/04/2016
helpviewer_keywords:
...
|-|-|
|名前|説明|
|`CMFCPrintPreviewToolBar::GetThisClass`|ポインターを取得する、framework によって使用される、 [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md)このクラス型に関連付けられているオブジェクト。|
