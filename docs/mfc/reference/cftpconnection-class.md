 ...
 *独自*  
 ファイルを取得するためのコンテキスト識別子です。 参照してください**解説**の詳細については*独自*です。  
...
### <a name="remarks"></a>Remarks  
 ...
 上書き、*独自*既定値は、コンテキスト識別子を独自の値に設定します。 コンテキスト識別子にこの特定の操作に関連付けられて、`CFtpConnection`によって作成されたオブジェクトの[CInternetSession](../../mfc/reference/cinternetsession-class.md)オブジェクト。 値が返される[:onstatuscallback](../../mfc/reference/cinternetsession-class.md#onstatuscallback)特定ために使用する操作の状態をします。 記事を参照して[インターネットの最初の手順: WinInet](../../mfc/wininet-basics.md)詳細については、コンテキスト識別子。  
 ...
 *独自*  
 ファイルを開くためのコンテキスト識別子です。 参照してください**解説**の詳細については*独自*です。  
 ...
 *独自*  
 ファイルを配置するためのコンテキスト識別子です。 参照してください**解説**の詳細については*独自*です。  
