---
title: CInternetConnection クラス |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
方法の詳細について`GetContext`ユーザー状態の情報を提供するその他の WinInet クラスは、記事を参照して[インターネットの最初の手順: WinInet](../../mfc/wininet-basics.md)コンテキスト識別子の詳細についてはします。
