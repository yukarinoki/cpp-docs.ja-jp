---
description: '詳細情報: CDockingManager クラス'
...
|[CDockingManager::AdjustPaneFrames](#adjustpaneframes)|WM_NCCALCSIZE メッセージをすべてのウィンドウおよびウィンドウに送信し `CPaneFrameWnd` ます。|
...
クラスは、 `CDockingManager` ペインまたはウィンドウを検索するために使用できるいくつかのサービスを実装し `CPaneFrameWnd` ます。 通常、これらのサービスはメインフレームウィンドウオブジェクトにラップされるため、直接呼び出さないでください。 詳細については、「 [CPaneFrameWnd クラス](../../mfc/reference/cpaneframewnd-class.md)」を参照してください。

## <a name="customization-tips"></a>カスタマイズのヒント

オブジェクトには、次のヒントが適用され `CDockingManager` ます。
...
クラスのさまざまなメソッドを使用してオブジェクトを構成する方法を次の例に示し `CDockingManager` `CDockingManager` ます。 この例では、追加のボタンを表示して、すべてのドッキングウィンドウのキャプションにポップアップメニューを開き、オブジェクトのドッキングモードを設定する方法を示します。 このコードスニペットは、 [Visual Studio のデモサンプル](../../overview/visual-cpp-samples.md)に含まれています。
...
## <a name="cdockingmanageraddminiframe"></a><a name="addminiframe"></a> CDockingManager:: AddMiniFrame フレーム
...
WM_NCCALCSIZE メッセージをすべてのウィンドウおよびウィンドウに送信し `CPaneFrameWnd` ます。
...
オブジェクトの配置 `CRect` が調整された場合は TRUE。それ以外の場合は FALSE。
...
## <a name="cdockingmanagerdeterminepaneandstatus"></a><a name="determinepaneandstatus"></a> CDockingManager::D Eて Eブランコ Andstatus
...
*bFloatMultiOnly*<br/>
からのインスタンスではないフレームを除外する場合は TRUE `CMultiPaneFrameWnd` 。それ以外の場合は FALSE。
...
## <a name="cdockingmanagergetdockingmode"></a><a name="getdockingmode"></a> CDockingManager:: Getdoc モード
...
## <a name="cdockingmanagergetpanelist"></a><a name="getpanelist"></a> CDockingManager:: Get List
...
## <a name="cdockingmanagergetsmartdockingmanager"></a><a name="getsmartdockingmanager"></a> CDockingManager:: Getsmartdoc王国マネージャー
...
## <a name="cdockingmanagergetsmartdockingmanagerpermanent"></a><a name="getsmartdockingmanagerpermanent"></a> CDockingManager:: Getsmartdocの Managermanagerパーマネント
...
## <a name="cdockingmanagergetsmartdockingparams"></a><a name="getsmartdockingparams"></a> CDockingManager:: Getsmartdocのパラメーター
...
## <a name="cdockingmanageronactivateframe"></a><a name="onactivateframe"></a> CDockingManager:: On Frame
...
フレームワークは、現在のメインウィンドウを閉じようとしているときに WM_DESTROY メッセージを送信します。 `CMFCPopupMenu` `CMFCPopupMenu` オブジェクトが WM_DESTROY メッセージを処理するときに、フレームウィンドウに属するオブジェクトからの通知を処理するには、このメソッドをオーバーライドします。
...
*pExtra*<br/>
から `CCmdUI` *NCode* が CN_UPDATE_COMMAND_UI 場合は、へのポインターにキャストされている void へのポインター。
...
## <a name="cdockingmanagersetdockingmode"></a><a name="setdockingmode"></a> CDockingManager:: Setdoc モード
...
## <a name="cdockingmanagersetprintpreviewmode"></a><a name="setprintpreviewmode"></a> CDockingManager:: Setprintプレビューモード
...
## <a name="cdockingmanagersetsmartdockingparams"></a><a name="setsmartdockingparams"></a> CDockingManager:: Setsmartdocのパラメーター
...
## <a name="cdockingmanagergetsmartdockingtheme"></a><a name="getsmartdockingtheme"></a> CDockingManager:: Getsmartdocのテーマ
