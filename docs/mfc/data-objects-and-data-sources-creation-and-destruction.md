---
description: '詳細については、「データオブジェクトとデータソース: 作成と破棄」を参照してください。'
...
1. これが **切り取り** 操作の場合、または DROPEFFECT_MOVE を返した場合は、 `DoDragDrop` 手順 1. で選択したデータがドキュメントから削除されます。 
