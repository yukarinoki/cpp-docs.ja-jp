---
title: 'TN053: DAO 用カスタム DFX ルーチン データベース クラス |Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
