...
5.  **プロパティ名**ボックスに、プロパティの名前を入力します。 この例では、使用**HeadingFont**します。  
  
6.  **[実装型]** として、 **[Get/Set メソッド]** をクリックします。  
  
7.  **プロパティ型**ボックスで、 **IDispatch** <strong>\*</strong>のプロパティの型。  
