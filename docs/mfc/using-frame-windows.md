...
ms.locfileid: "57259660"
---
# <a name="using-frame-windows"></a>フレーム ウィンドウの使用

MFC フレームワークは、ドキュメント フレーム ウィンドウを作成、ドキュメントとビュー-新機能と [ファイル] メニュー コマンドの実装の一部として。 作成、使用、およびそれらのウィンドウの破棄で小規模の役割のみを再生するため、フレームワーク、フレーム ウィンドウの作業のほとんどの役割。 できます、ただし、明示的に作成する独自のフレーム ウィンドウと子ウィンドウの特別な目的。
...
- [ドラッグして、フレーム ウィンドウ内のファイルの削除](../mfc/dragging-and-dropping-files-in-a-frame-window.md)
