...
1. 最初のページで、 **MFC アプリケーション ウィザード**、 をクリックして**次**します。

1. **アプリケーションの種類**] ページ [**視覚スタイルと色**を選択します**Office 2007 (青のテーマ)** します。 その他の設定はそのままにします。 **[次へ]** をクリックします。

1. **複合ドキュメント サポート**ことを確認します ページで、 **None**が選択されているし、をクリックし、 **次へ**します。

1. **ドキュメント テンプレート プロパティ**ページで、**ファイル拡張子**ボックスに、このアプリケーションを作成、たとえば、ドキュメントのファイル名拡張子を入力*mfcrbnapp*. **[次へ]** をクリックします。

1. **データベース サポート**ことを確認します ページで、 **None**が選択されているし、をクリックし、 **次へ**。

1. **ユーザー インターフェイス機能**ことを確認します ページで、**リボンを使用する**が選択されています。 **[次へ]** をクリックします。
