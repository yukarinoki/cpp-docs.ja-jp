...
ms.locfileid: "36932261"
---
# <a name="crebar-vs-crebarctrl"></a>CReBar vs です。CReBarCtrl
MFC には、rebars を作成する 2 つのクラスが用意されています: [CReBar](../mfc/reference/crebar-class.md)と[CReBarCtrl](../mfc/reference/crebarctrl-class.md) (をラップする Windows のコモン コントロール API)。 `CReBar` すべての共通の rebar コントロールの機能を提供するため、必要な共通コントロールの設定と構造の多くを処理します。  
