...
## <a name="multiple-document-types"></a><a name="_core_multiple_document_types"></a>複数のドキュメントタイプ
...
![複数の&#45;ビューのユーザー インターフェイス](../mfc/media/vc37a71.gif "複数の&#45;ビューのユーザー インターフェイス") <br/>
...
## <a name="multiple-frame-windows"></a><a name="_core_multiple_frame_windows"></a>複数フレーム ウィンドウ
...
## <a name="splitter-windows"></a><a name="_core_splitter_windows"></a>スプリッタウィンドウ
