---
title: Crowset::close |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33096731"
---
# <a name="crowsetclose"></a>CRowset::Close
行と、現在のリリース[IRowset](https://msdn.microsoft.com/en-us/library/ms720986.aspx)インターフェイスです。  
