---
description: 詳細については、_InterlockedExchangeAdd 組み込み関数」を参照してください。
title: 組み込み関数の _InterlockedExchangeAdd
ms.date: 09/02/2019
f1_keywords:
...
ms.locfileid: "97168021"
---
# <a name="_interlockedexchangeadd-intrinsic-functions"></a>組み込み関数の _InterlockedExchangeAdd
...
の使用例については `_InterlockedExchangeAdd` 、「 [_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md)」を参照してください。
