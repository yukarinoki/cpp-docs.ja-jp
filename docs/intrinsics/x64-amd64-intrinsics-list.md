...
|_andn_u64|BMI [1]|ammintrin.h|署名されていない __int64 _andn_u64 (unsigned _int64、署名されていない \_ \_ _int64)|
...
|_bextri_u64|ABM [1]|ammintrin.h|署名されていない __int64 _bextri_u64 (unsigned \_ _int64、unsigned int)|
...
|_blcfill_u64|ABM [1]|ammintrin.h|署名されていない __int64 _blcfill_u64 (unsigned \_ _int64)|
|_blci_u32|ABM [1]|ammintrin.h|unsigned int _blci_u32(unsigned int)|
|_blci_u64|ABM [1]|ammintrin.h|署名されていない __int64 _blci_u64 (unsigned \_ _int64)|
|_blcic_u32|ABM [1]|ammintrin.h|unsigned int _blcic_u32(unsigned int)|
|_blcic_u64|ABM [1]|ammintrin.h|署名されていない __int64 _blcic_u64 (unsigned \_ _int64)|
|_blcmsk_u32|ABM [1]|ammintrin.h|unsigned int _blcmsk_u32(unsigned int)|
|_blcmsk_u64|ABM [1]|ammintrin.h|署名されていない __int64 _blcmsk_u64 (unsigned \_ _int64)|
|_blcs_u32|ABM [1]|ammintrin.h|unsigned int _blcs_u32(unsigned int)|
|_blcs_u64|ABM [1]|ammintrin.h|署名されていない __int64 _blcs_u64 (unsigned \_ _int64)|
|_blsfill_u32|ABM [1]|ammintrin.h|unsigned int _blsfill_u32(unsigned int)|
|_blsfill_u64|ABM [1]|ammintrin.h|署名されていない __int64 _blsfill_u64 (unsigned \_ _int64)|
...
|[_blsi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u64)|BMI|ammintrin.h, immintrin.h|署名されていない __int64 _blsi_u64 (unsigned \_ _int64)|
|_blsic_u32|ABM [1]|ammintrin.h|unsigned int _blsic_u32(unsigned int)|
|_blsic_u64|ABM [1]|ammintrin.h|署名されていない __int64 _blsic_u64 (unsigned \_ _int64)|
...
|[_blsmsk_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u64)|BMI|ammintrin.h, immintrin.h|署名されていない __int64 _blsmsk_u64 (unsigned \_ _int64)|
...
|[_blsr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u64)|BMI|ammintrin.h, immintrin.h|署名されていない __int64 _blsr_u64 (unsigned \_ _int64)|
...
|[_bzhi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64)|BMI [2]|immintrin.h|署名されていない __int64 _bzhi_u64 (unsigned \_ _int64、unsigned int)|
...
|[_InterlockedCompareExchange16_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|短い _InterlockedCompareExchange16_np (短い揮発性 \* 、短い、短い)|
...
|_load_be_u64<br /><br /> [_loadbe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i64&expand=3073)|MOVBE|immintrin.h|unsigned __int64 _load_be_u64 (void const \* );<br /><br /> \__int64 _loadbe_i64 (void const \* ) です。番|
...
|[_lzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u64)|BMI|ammintrin.h, immintrin.h|署名されていない __int64 _lzcnt_u64 (unsigned \_ _int64)|
|[__lzcnt16](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|unsigned short __lzcnt16(unsigned short)|
|[__lzcnt64](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|署名されていない __int64 \_ _lzcnt64 (unsigned \_ _int64)|
...
|[_mm_crc32_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u64)|SSE42|intrin.h|署名されていない __int64 _mm_crc32_u64 (unsigned _int64、署名されていない \_ \_ _int64)|
...
|[__movsq](movsq.md)||intrin.h|VOID __movsq (符号なし \_ _int64 \* 、符号なし \_ _int64 const \* 、size_t)|
...
|_mulx_u64|BMI [2]|immintrin.h|署名されていない __int64 _mulx_u64 (unsigned _int64、署名されていない _int64、署名されていない \_ \_ \_ _int64 \* )|
...
|[_pdep_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64)|BMI [2]|immintrin.h|署名されていない __int64 _pdep_u64 (unsigned _int64、署名されていない \_ \_ _int64)|
...
|[_pext_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64)|BMI [2]|immintrin.h|署名されていない __int64 _pext_u64 (unsigned _int64、署名されていない \_ \_ _int64)|
...
|[__popcnt64](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|署名されていない __int64 \_ _popcnt64 (unsigned \_ _int64)|
...
|[__readcr0](readcr0.md)||intrin.h|署名されていない __int64 \_ _readcr0 (void)|
|[__readcr2](readcr2.md)||intrin.h|署名されていない __int64 \_ _readcr2 (void)|
|[__readcr3](readcr3.md)||intrin.h|署名されていない __int64 \_ _readcr3 (void)|
|[__readcr4](readcr4.md)||intrin.h|署名されていない __int64 \_ _readcr4 (void)|
|[__readcr8](readcr8.md)||intrin.h|署名されていない __int64 \_ _readcr8 (void)|
|[__readdr](readdr.md)||intrin.h|署名されていない __int64 \_ _readdr (符号なし)|
|[__readeflags](readeflags.md)||intrin.h|署名されていない __int64 \_ _readeflags (void)|
...
|[__readgsqword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|符号なし __int64 \_ _readgsqword (unsigned long)|
...
|[__shiftleft128](shiftleft128.md)||intrin.h|署名されていない __int64 _shiftleft128 (署名されていない _int64、署名されていない \_ \_ \_ _int64、unsigned char)|
|[__shiftright128](shiftright128.md)||intrin.h|署名されていない __int64 _shiftright128 (署名されていない _int64、署名されていない \_ \_ \_ _int64、unsigned char)|
|_shlx_u32|BMI [2]|immintrin.h|unsigned int _shlx_u32 (符号なし整数、符号なし int)|
|_shlx_u64|BMI [2]|immintrin.h|署名されていない __int64 _shlx_u64 (unsigned \_ _int64、unsigned int)|
|_shrx_u32|BMI [2]|immintrin.h|unsigned int _shrx_u32 (符号なし整数、符号なし int)|
|_shrx_u64|BMI [2]|immintrin.h|署名されていない __int64 _shrx_u64 (unsigned \_ _int64、unsigned int)|
...
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void _store_be_u64 (void \* 、unsigned \_ _int64)、<br /><br /> void _storebe_i64 (void \* 、 \_ _int64) です。番|
...
|[__stosq](stosq.md)||intrin.h|void __stosq (署名されていない _int64、署名されていない \_ \* \_ _int64、size_t)|
...
|_t1mskc_u64|ABM [1]|ammintrin.h|署名されていない __int64 _t1mskc_u64 (unsigned \_ _int64)|
...
|[_tzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u64)|BMI|ammintrin.h, immintrin.h|署名されていない __int64 _tzcnt_u64 (unsigned \_ _int64)|
|_tzmsk_u32|ABM [1]|ammintrin.h|unsigned int _tzmsk_u32(unsigned int)|
|_tzmsk_u64|ABM [1]|ammintrin.h|署名されていない __int64 _tzmsk_u64 (unsigned \_ _int64)|
|[__ud2](ud2.md)||intrin.h|void __ud2(void)|
|[_udiv128](udiv128.md)||intrin.h|署名されていない __int64 _udiv128 (署名されていない _int64、署名されていない _int64、署名されていない \_ \_ \_ _int64、 \_ \*|
...
|[_umul128](umul128.md)||intrin.h|署名されていない __int64 _umul128 (unsigned _int64、署名されていない _int64、署名されていない \_ \_ \_ _int64 \* )|
|[__umulh](umulh.md)||intrin.h|署名されていない __int64 \_ _umulh (unsigned _int64、署名されていない \_ \_ _int64)|
...
|[__writedr](writedr.md)||intrin.h|void __writedr (符号なし、署名されていない \_ _int64)|
