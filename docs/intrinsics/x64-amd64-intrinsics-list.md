...
ms.locfileid: "81754317"
---
# <a name="x64-amd64-intrinsics-list"></a>x64 (amd64) 組み込み一覧

このドキュメントでは、x64 (amd64 とも呼ばれます) が対象とされるときに Microsoft C++ コンパイラでサポートされる組み込みについて説明します。
...
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|符号なし char _addcarry_u64 (符号なし文字\_、符号なし_int64、符号\_なし_int64、符号なし\__int64 \*)|
...
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|符号なし char _addcarryx_u64 (符号なし文字\_、符号なし_int64、署名\_されていない_int64、符号なし\__int64 \*)|
|[__addgsbyte](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsbyte (符号なし長、符号なし文字)|
|[__addgsdword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsdword (符号なし長、符号なし int)|
|[__addgsqword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (符号なし長、\_符号なし_int64)|
|[__addgsword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsword (符号なし長、符号なしショート)|
|[_AddressOfReturnAddress](addressofreturnaddress.md)||intrin.h|ボイド\*_AddressOfReturnAddress(ボイド)|
|_andn_u32|BMI [1]|ammintrin.h|符号なし int _andn_u32 (符号なし、符号なし int)|
|_andn_u64|BMI [1]|ammintrin.h|署名されていない__int64_andn_u64 (未\_署名_int64、未\_署名の_int64)|
...
|[_bextr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bextr_u64)|BMI|ammintrin.h, immintrin.h|署名されていない__int64 _bextr_u64 (\_未署名の_int64、符号なし、符号なし int)|
|_bextri_u32|ABM [1]|ammintrin.h|符号なし int _bextri_u32 (符号なし、符号なし int)|
|_bextri_u64|ABM [1]|ammintrin.h|未署名__int64_bextri_u64(未署名\__int64、符号なし int)|
|[_BitScanForward](bitscanforward-bitscanforward64.md)||intrin.h|符号なし char _BitScanForward (\*符号なし長、符号なし長)|
|[_BitScanForward64](bitscanforward-bitscanforward64.md)||intrin.h|符号なし char _BitScanForward64 (\*符号なし長\_、符号なし_int64)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin.h|符号なし char _BitScanReverse(符号\*なし長、符号なし長)|
|[_BitScanReverse64](bitscanreverse-bitscanreverse64.md)||intrin.h|符号なし char _BitScanReverse64 (\*符号なし長\_、符号なし_int64)|
|[_bittest](bittest-bittest64.md)||intrin.h|符号なし文字_bittest(長い\*定数、長い)|
|[_bittest64](bittest-bittest64.md)||intrin.h|符号なし char\__bittest64( \* \__int64 const , _int64)|
|[_bittestandcomplement](bittestandcomplement-bittestandcomplement64.md)||intrin.h|符号なし文字_bittestandcomplement(長\*い、 長い)|
|[_bittestandcomplement64](bittestandcomplement-bittestandcomplement64.md)||intrin.h|符号なし文字_bittestandcomplement64(\_ \*_int64 \_, _int64)|
|[_bittestandreset](bittestandreset-bittestandreset64.md)||intrin.h|符号なし文字_bittestandreset(長\*い、 長い)|
|[_bittestandreset64](bittestandreset-bittestandreset64.md)||intrin.h|符号なし文字_bittestandreset64(\_ \*_int64 \_, _int64)|
|[_bittestandset](bittestandset-bittestandset64.md)||intrin.h|符号なし文字_bittestandset(長\*い、 長い)|
|[_bittestandset64](bittestandset-bittestandset64.md)||intrin.h|符号なし文字_bittestandset64(\_ \*_int64 \_, _int64)|
|_blcfill_u32|ABM [1]|ammintrin.h|unsigned int _blcfill_u32(unsigned int)|
|_blcfill_u64|ABM [1]|ammintrin.h|未署名__int64_blcfill_u64 (署名\_されていない_int64)|
|_blci_u32|ABM [1]|ammintrin.h|unsigned int _blci_u32(unsigned int)|
|_blci_u64|ABM [1]|ammintrin.h|符号なし__int64_blci_u64(未署名\__int64)|
|_blcic_u32|ABM [1]|ammintrin.h|unsigned int _blcic_u32(unsigned int)|
|_blcic_u64|ABM [1]|ammintrin.h|署名されていない__int64_blcic_u64 (署名\_されていない_int64)|
|_blcmsk_u32|ABM [1]|ammintrin.h|unsigned int _blcmsk_u32(unsigned int)|
|_blcmsk_u64|ABM [1]|ammintrin.h|未署名__int64_blcmsk_u64 (未\_署名_int64)|
|_blcs_u32|ABM [1]|ammintrin.h|unsigned int _blcs_u32(unsigned int)|
|_blcs_u64|ABM [1]|ammintrin.h|未署名__int64 _blcs_u64 (\_署名されていない_int64)|
|_blsfill_u32|ABM [1]|ammintrin.h|unsigned int _blsfill_u32(unsigned int)|
|_blsfill_u64|ABM [1]|ammintrin.h|署名されていない__int64_blsfill_u64 (未\_署名の_int64)|
...
|[_blsi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u64)|BMI|ammintrin.h, immintrin.h|署名されていない__int64_blsi_u64 (署名\_されていない_int64)|
|_blsic_u32|ABM [1]|ammintrin.h|unsigned int _blsic_u32(unsigned int)|
|_blsic_u64|ABM [1]|ammintrin.h|署名されていない__int64_blsic_u64 (署名\_されていない_int64)|
...
|[_blsmsk_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u64)|BMI|ammintrin.h, immintrin.h|署名されていない__int64_blsmsk_u64 (署名\_されていない_int64)|
...
|[_blsr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u64)|BMI|ammintrin.h, immintrin.h|署名されていない__int64_blsr_u64 (署名\_されていない_int64)|
...
|[_bzhi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64)|BMI [2]|immintrin.h|署名されていない__int64 _bzhi_u64 (\_未署名の_int64、署名なし int)|
...
|[_fxsave64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxsave64)|FXSR [2]|immintrin.h|ボイド_fxsave64(ボイド\*)|
...
|[_InterlockedAnd_np](interlockedand-intrinsic-functions.md)||intrin.h|長い_InterlockedAnd_np(\*長い 、長い)|
|[_InterlockedAnd16](interlockedand-intrinsic-functions.md)||intrin.h|ショート_InterlockedAnd16(ショート揮発性\*、ショート)|
|[_InterlockedAnd16_np](interlockedand-intrinsic-functions.md)||intrin.h|短い_InterlockedAnd16_np(\*短い 、 ショート)|
|[_InterlockedAnd64](interlockedand-intrinsic-functions.md)||intrin.h|__int64_InterlockedAnd64(_int64\_揮発性\* \_、_int64)|
|[_InterlockedAnd64_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedAnd64_HLEAcquire(\_揮発性\*_int64 \_、_int64)|
|[_InterlockedAnd64_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedAnd64_HLERelease(_int64\_揮発性\*、_int64) \_|
|[_InterlockedAnd64_np](interlockedand-intrinsic-functions.md)||intrin.h|__int64_InterlockedAnd64_np(_int64、_int64)\_ \* \_|
|[_InterlockedAnd8](interlockedand-intrinsic-functions.md)||intrin.h|char _InterlockedAnd8(char\*揮発性、char)|
|[_InterlockedAnd8_np](interlockedand-intrinsic-functions.md)||intrin.h|文字_InterlockedAnd8_np(char,char) \*|
...
|[_interlockedbittestandreset64](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|符号なし文字_interlockedbittestandreset64(\_ \*_int64 \_, _int64)|
|[_interlockedbittestandreset64_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|符号なし文字_interlockedbittestandreset64_HLEAcquire(\_ \*_int64 \_, _int64)|
|[_interlockedbittestandreset64_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|符号なし文字_interlockedbittestandreset64_HLERelease(\_ \*_int64 \_, _int64)|
...
|[_interlockedbittestandset64](interlockedbittestandset-intrinsic-functions.md)||intrin.h|符号なし文字_interlockedbittestandset64(\_ \*_int64 \_, _int64)|
|[_interlockedbittestandset64_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|符号なし文字_interlockedbittestandset64_HLEAcquire(\_ \*_int64 \_、 _int64)|
|[_interlockedbittestandset64_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|符号なし char\__interlockedbittestandset64_HLERelease( _int64 \*, \__int64)|
...
|[_InterlockedCompareExchange_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|長い_InterlockedCompareExchange_np(\*長い、長い、長い)|
|[_InterlockedCompareExchange128](interlockedcompareexchange128.md)||intrin.h|符号なし char\__InterlockedCompareExchange128( \* \__int64\_揮発性\_、\*_int64、 _int64、 _int64 )|
|[_InterlockedCompareExchange128_np](interlockedcompareexchange128.md)||intrin.h|符号なし char\__InterlockedCompareExchange128( \* \__int64\_揮発性\_、\*_int64、 _int64、 _int64 )|
...
|[_InterlockedCompareExchange16_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|短い_InterlockedCompareExchange16_np(短\*い揮発性 、短い、短い)|
...
|[_InterlockedCompareExchangePointer_np](interlockedcompareexchangepointer-intrinsic-functions.md)||intrin.h|ボイド\*_InterlockedCompareExchangePointer_np(ボイド\*\*、\*ボイド、\*ボイド)|
...
|[_InterlockedDecrement64](interlockeddecrement-intrinsic-functions.md)||intrin.h|__int64_InterlockedDecrement64(_int64\_揮発性\*)|
...
|[_InterlockedExchange64](interlockedexchange-intrinsic-functions.md)||intrin.h|__int64_InterlockedExchange64(_int64\_揮発性\*、_int64) \_|
|[_InterlockedExchange64_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedExchange64_HLEAcquire(_int64\_揮発性\* \_、_int64)|
|[_InterlockedExchange64_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedExchange64_HLERelease(_int64\_揮発性\*、_int64) \_|
...
|[_InterlockedExchangeAdd16](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|ショート_InterlockedExchangeAdd16(ショート揮発性\*、ショート)|
|[_InterlockedExchangeAdd64](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|__int64_InterlockedExchangeAdd64(_int64\_揮発性\* \_、_int64)|
|[_InterlockedExchangeAdd64_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedExchangeAdd64_HLEAcquire(\_揮発性\*_int64、_int64) \_|
|[_InterlockedExchangeAdd64_HLERelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedExchangeAdd64_HLERelease(_int64\_揮発性\* \_、_int64)|
...
|[_InterlockedExchangePointer_HLERelease](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|ボイド * \*_InterlockedExchangePointer_HLERelease(\*ボイド揮発性\*、 ボイド )|
...
|[_InterlockedIncrement64](interlockedincrement-intrinsic-functions.md)||intrin.h|__int64_InterlockedIncrement64(_int64\_揮発性\*)|
...
|[_InterlockedOr_np](interlockedor-intrinsic-functions.md)||intrin.h|長い_InterlockedOr_np(\*長い 、長い)|
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin.h|ショート_InterlockedOr16(短揮発性\*、ショート)|
|[_InterlockedOr16_np](interlockedor-intrinsic-functions.md)||intrin.h|ショート_InterlockedOr16_np(ショート\*、 ショート )|
|[_InterlockedOr64](interlockedor-intrinsic-functions.md)||intrin.h|__int64_InterlockedOr64(\_揮発性_int64 \* \_、_int64)|
|[_InterlockedOr64_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedOr64_HLEAcquire(\_揮発性_int64 \* \_、_int64)|
|[_InterlockedOr64_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedOr64_HLERelease(\_揮発性\*_int64、_int64) \_|
...
|[_InterlockedOr8_np](interlockedor-intrinsic-functions.md)||intrin.h|文字_InterlockedOr8_np(char,char) \*|
...
|[_InterlockedXor_np](interlockedxor-intrinsic-functions.md)||intrin.h|長い_InterlockedXor_np(\*長い 、長い)|
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin.h|短い_InterlockedXor16(短\*い揮発性、短い)|
|[_InterlockedXor16_np](interlockedxor-intrinsic-functions.md)||intrin.h|短い_InterlockedXor16_np(\*短い、短い)|
|[_InterlockedXor64](interlockedxor-intrinsic-functions.md)||intrin.h|__int64_InterlockedXor64(_int64\_揮発性\*、_int64) \_|
|[_InterlockedXor64_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedXor64_HLEAcquire(\_揮発性\*_int64、_int64) \_|
|[_InterlockedXor64_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64_InterlockedXor64_HLERelease(_int64\_揮発性\* \_、_int64)|
|[_InterlockedXor64_np](interlockedxor-intrinsic-functions.md)||intrin.h|__int64_InterlockedXor64_np(_int64、_int64)\_ \* \_|
|[_InterlockedXor8](interlockedxor-intrinsic-functions.md)||intrin.h|文字_InterlockedXor8(char\*揮発性、char)|
|[_InterlockedXor8_np](interlockedxor-intrinsic-functions.md)||intrin.h|文字_InterlockedXor8_np(char、\*文字)|
...
|_load_be_u64<br /><br /> [_loadbe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i64&expand=3073)|MOVBE|immintrin.h|符号なし__int64_load_be_u64(void\*const);<br /><br /> \__int64_loadbe_i64(void\*const);[3]|
|__lwpins32|LWP [1]|ammintrin.h|符号なし char __lwpins32 (符号なし、符号なし、符号なし int、符号なし int)|
|__lwpins64|LWP [1]|ammintrin.h|符号なし char __lwpins64(\_符号なし_int64、符号なし、符号なし int、 符号なし int)|
|__lwpval32|LWP [1]|ammintrin.h|void __lwpval32 (符号なし、符号なし、符号なし int、 符号なし int)|
|__lwpval64|LWP [1]|ammintrin.h|void __lwpval64 (\_符号なし_int64、符号なし、符号なし int)|
...
|[_lzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u64)|BMI|ammintrin.h, immintrin.h|署名されていない__int64_lzcnt_u64 (署名\_されていない_int64)|
|[__lzcnt16](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|unsigned short __lzcnt16(unsigned short)|
|[__lzcnt64](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|署名されていない__int64_lzcnt64 \_(署名\_されていない_int64)|
...
|[_mm_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_broadcast_ss)|AVX [2]|immintrin.h|__m128 _mm_broadcast_ss(浮動小数点\*定数)|
...
|[_mm_crc32_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u64)|SSE42|intrin.h|未署名の__int64 _mm_crc32_u64(\_未署名_int64、\_署名なし_int64)|
...
|[_mm_cvtsi64_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsi64_si128)|SSE2|intrin.h|__m128i_mm_cvtsi64_si128_int64)\_|
...
|[_mm_extract_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_epi64)|SSE41|intrin.h|__int64_mm_extract_epi64(_m128i、const\_int)|
...
|[_mm_insert_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi64)|SSE41|intrin.h|__m128i_mm_insert_epi64(_m128i、_int64、const\_ \_int)|
...
|[_mm_popcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_popcnt_u64)|POPCNT|intrin.h|__int64 _mm_popcnt_u64(未\_署名_int64)|
|[_mm_prefetch](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_prefetch)|SSE|intrin.h|ボイド_mm_prefetch(char\*, int)|
...
|[_mm_stream_si64x](mm-stream-si64x.md)|SSE2|intrin.h|ボイド_mm_stream_si64x(_int64、_int64)\_ \* \_|
...
|[_mm256_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|__m256i_mm256_mask_i32gather_epi64(_m256i、_int64・\\\_\_コンスト\_*、_m128i、_m256i、const \_int)|
...
|[_mm256_set_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi64x)|AVX [2]|immintrin.h|__m256i_mm256_set_epi64x(長い長い、長い長い、長い長い、長い)|
...
|[_mm256_setr_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_epi64x)|AVX [2]|immintrin.h|__m256i_mm256_setr_epi64x(長い長い、長い長い、長い長い、長い)|
...
|[__movsb](movsb.md)||intrin.h|VOID __movsb(符号なし\*文字、符号なし\*char const 、size_t)|
|[__movsd](movsd.md)||intrin.h|VOID __movsd(符号なし\*長、符号なし長\*い定数、size_t)|
|[__movsq](movsq.md)||intrin.h|VOID __movsq(未\_署名\*の_int64 \_、符号\*なし_int64 const 、size_t)|
|[__movsw](movsw.md)||intrin.h|VOID __movsw(符号なし\*ショート、符号なしショート\*コンスト、size_t)|
|[_mul128](mul128.md)||intrin.h|__int64 _mul128(_int64、_int64、_int64)\_ \_ \_ \*|
...
|_mulx_u64|BMI [2]|immintrin.h|署名されていない__int64 _mulx_u64 (\_未署名の_int64、署名\_されていない_int64、署名されていない\__int64\*)|
...
|[_pdep_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64)|BMI [2]|immintrin.h|署名されていない__int64 _pdep_u64 (\_未署名の_int64、未署名\_の_int64)|
...
|[_pext_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64)|BMI [2]|immintrin.h|署名されていない__int64_pext_u64(未署名\__int64、署名\_されていない_int64)|
...
|[__popcnt64](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|署名されていない__int64 \__popcnt64 (\_署名されていない_int64)|
...
|[_rdrand64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand64_step)|RDRAND [2]|immintrin.h|int _rdrand64_step (\_署名\*なし_int64 )|
...
|[_rdseed64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed64_step)|RDSEED [2]|immintrin.h|int _rdseed64_step (\_未\*署名_int64 )|
...
|[__readcr0](readcr0.md)||intrin.h|符号なし__int64 \__readcr0(void)|
|[__readcr2](readcr2.md)||intrin.h|符号なし__int64 \__readcr2(void)|
|[__readcr3](readcr3.md)||intrin.h|符号なし__int64_readcr3(\_ボイド)|
|[__readcr4](readcr4.md)||intrin.h|符号なし__int64_readcr4(\_ボイド)|
|[__readcr8](readcr8.md)||intrin.h|符号なし__int64 \__readcr8(void)|
|[__readdr](readdr.md)||intrin.h|署名されていない__int64 \__readdr (未署名)|
|[__readeflags](readeflags.md)||intrin.h|符号なし__int64 \__readeflags(void)|
...
|[__readgsbyte](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|符号なし文字__readgsbyte(符号なし長)|
|[__readgsdword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|符号なし長__readgsdword(符号なし長)|
|[__readgsqword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|符号なし__int64 \__readgsqword (符号なし長)|
|[__readgsword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|符号なしのショート__readgsword(符号なし長)|
...
|_rorx_u64|BMI [2]|immintrin.h|符号なし__int64_rorx_u64(符号\_なし_int64、const 符号なし int)|
...
|_sarx_i64|BMI [2]|immintrin.h|__int64_sarx_i64(_int64、\_符号なし int)|
|[__segmentlimit](segmentlimit.md)||intrin.h|符号なし長__segmentlimit(符号なし長)|
|_sgdt||intrin.h|ボイド_sgdt(ボイド\*)|
|[__shiftleft128](shiftleft128.md)||intrin.h|符号なし__int64 \__shiftleft128(未\_署名_int64、符号\_なし_int64、符号なし char)|
|[__shiftright128](shiftright128.md)||intrin.h|未署名__int64 \__shiftright128(未\_署名_int64、未\_署名_int64、符号なし char)|
|_shlx_u32|BMI [2]|immintrin.h|符号なし int _shlx_u32 (符号なし、符号なし int)|
|_shlx_u64|BMI [2]|immintrin.h|符号なし__int64_shlx_u64(未署名\__int64、符号なし int)|
|_shrx_u32|BMI [2]|immintrin.h|符号なし int _shrx_u32 (符号なし、符号なし int)|
|_shrx_u64|BMI [2]|immintrin.h|符号なし__int64_shrx_u64(未署名\_の_int64、符号なし int)|
...
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void _store_be_u64(void \*、\_署名されていない_int64)。<br /><br /> ボイド_storebe_i64(void \* \_,_int64);[3]|
|_Store_HLERelease|HLE [2]|immintrin.h|ボイド_Store_HLERelease(長揮発性\*、長)|
|_Store64_HLERelease|HLE [2]|immintrin.h|ボイド_Store64_HLERelease(_int64\_揮発性\* \_、_int64)|
...
|[__stosq](stosq.md)||intrin.h|void __stosq(未\_署名\*_int64 、\_署名されていない_int64、size_t)|
...
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin.h|符号なし char _subborrow_u64 (符号なし文字\_、符号なし_int64、符号\_なし_int64、符号なし\__int64 \*)|
...
|_t1mskc_u64|ABM [1]|ammintrin.h|未署名の__int64_t1mskc_u64 (\_未署名_int64)|
...
|[_tzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u64)|BMI|ammintrin.h, immintrin.h|署名されていない__int64_tzcnt_u64 (署名\_されていない_int64)|
|_tzmsk_u32|ABM [1]|ammintrin.h|unsigned int _tzmsk_u32(unsigned int)|
|_tzmsk_u64|ABM [1]|ammintrin.h|署名されていない__int64_tzmsk_u64 (署名\_されていない_int64)|
|[__ud2](ud2.md)||intrin.h|void __ud2(void)|
|[_udiv128](udiv128.md)||intrin.h|未署名__int64 _udiv128 (\_未署名_int64、\_未署名_int64、\_未署名_int64、\_未\*署名_int64)|
|[_udiv64](udiv64.md)||intrin.h|符号なし int \_udiv64(\_未署名_int64、符号なし int、符号なし int*|
|[__ull_rshift](ull-rshift.md)||intrin.h|符号なし__int64 [パスカル/cdecl] \__ull_rshift(\_符号なし_int64、int)|
|[_umul128](umul128.md)||intrin.h|署名されていない__int64 _umul128 (\_未署名の_int64、未署名\_の\__int64、未署名の_int64 \*)|
|[__umulh](umulh.md)||intrin.h|署名されていない__int64 \__umulh (\_未署名_int64、\_署名されていない_int64)|
|[__vmx_off](vmx-off.md)||intrin.h|void __vmx_off(void)|
|[__vmx_on](vmx-on.md)||intrin.h|符号なし文字__vmx_on (符号\_なし\*_int64 )|
|[__vmx_vmclear](vmx-vmclear.md)||intrin.h|符号なし文字__vmx_vmclear (符号\_なし\*_int64 )|
|[__vmx_vmlaunch](vmx-vmlaunch.md)||intrin.h|unsigned char __vmx_vmlaunch(void)|
|[__vmx_vmptrld](vmx-vmptrld.md)||intrin.h|符号なし文字__vmx_vmptrld (符号\_なし\*_int64 )|
|[__vmx_vmptrst](vmx-vmptrst.md)||intrin.h|void __vmx_vmptrst (\_署名\*されていない_int64 )|
|[__vmx_vmread](vmx-vmread.md)||intrin.h|符号なし文字__vmx_vmread(size_t、size_t)\*|
|[__vmx_vmresume](vmx-vmresume.md)||intrin.h|unsigned char __vmx_vmresume(void)|
|[__vmx_vmwrite](vmx-vmwrite.md)||intrin.h|符号なし文字__vmx_vmwrite(size_t、size_t)|
|[__wbinvd](wbinvd.md)||intrin.h|void __wbinvd(void)|
|[_WriteBarrier](writebarrier.md)||intrin.h|void _WriteBarrier(void)|
|[__writecr0](writecr0.md)||intrin.h|void __writecr0 (\_署名されていない_int64)|
|[__writecr3](writecr3.md)||intrin.h|void __writecr3 (\_署名なし_int64)|
|[__writecr4](writecr4.md)||intrin.h|void __writecr4 (\_署名されていない_int64)|
|[__writecr8](writecr8.md)||intrin.h|void __writecr8 (\_未署名_int64)|
|[__writedr](writedr.md)||intrin.h|void __writedr (未署名、\_符号なし_int64)|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags (\_未署名_int64)|
...
|[_writefsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u64)|FSGSBASE [2]|immintrin.h|void _writefsbase_u64 (\_署名なし_int64)|
...
|[_writegsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u64)|FSGSBASE [2]|immintrin.h|void _writegsbase_u64 (\_署名されていない_int64)|
|[__writegsbyte](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsbyte (符号なし長、符号なし文字)|
|[__writegsdword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsdword(符号なし長、符号なし長)|
|[__writegsqword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (符号なし長、\_符号なし_int64)|
|[__writegsword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsword (符号なし長、符号なしショート)|
...
|[_xrstor64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64)|XSAVE [2]|immintrin.h|void _xrstor64(void\*const \_, 符号なし_int64)|
...
|[_xsave64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64)|XSAVE [2]|immintrin.h|void _xsave64(void\*,\_未署名の_int64)|
...
|[_xsaveopt64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt64)|XSAVEOPT [2]|immintrin.h|void _xsaveopt64\*(void \_、 未署名の_int64)|
