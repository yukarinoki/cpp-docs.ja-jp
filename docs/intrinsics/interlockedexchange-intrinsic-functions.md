---
description: 詳細については、_InterlockedExchange 組み込み関数」を参照してください。
title: 組み込み関数の _InterlockedExchange
ms.date: 09/02/2019
f1_keywords:
...
ms.locfileid: "97168047"
---
# <a name="_interlockedexchange-intrinsic-functions"></a>組み込み関数の _InterlockedExchange
...
の使用例については `_InterlockedExchange` 、「 [_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md)」を参照してください。
