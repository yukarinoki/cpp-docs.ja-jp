...
プリプロセッサ ステートメントは、ソース ファイル ステートメントと同じ文字セットを使用しますが、エスケープ シーケンスはサポートされていません。 プリプロセッサ ステートメントで使用する文字セットが同じ、[実行文字セット](http://msdn.microsoft.com/a7901c61-524d-47c6-beb6-d9dacc2e72ed)します。 プリプロセッサは、負の文字値も認識します。
