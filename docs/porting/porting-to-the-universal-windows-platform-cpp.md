...
2. **[プロジェクトのプロパティ]** ウィンドウを開き、**[C++]** の **[全般]** で**プラットフォーム ツールセット**を Visual Studio 2017 のツールセットである **v141** に設定します。
...
7. 使用していないプロジェクトと同じプロジェクト名を使っていない場合は、Package.appxmanifest ファイルを開き、**エントリ ポイント**を更新して、`App` クラスの名前空間の名前を反映します。
