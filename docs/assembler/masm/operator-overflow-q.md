...
ms.locfileid: "32054960"
---
# <a name="operator-overflow"></a>OVERFLOW? 演算子
オーバーフロー フラグの状態です。 内でのみ使用[です。IF](../../assembler/masm/dot-if.md)、[です。中に](../../assembler/masm/dot-while.md)、または[です。繰り返し](../../assembler/masm/dot-repeat.md)をブロックし、アセンブリ時ではなく、実行時に評価されます。  
