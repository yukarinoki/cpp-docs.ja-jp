---
title: ML の致命的でないエラー A2010 |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32055601"
---
# <a name="ml-nonfatal-error-a2010"></a>ML の致命的でないエラー A2010
**無効な型の式**  
  
 オペランドに[この](../../assembler/masm/operator-this.md)または[PTR](../../assembler/masm/operator-ptr.md)有効な型の式ではありません。  
