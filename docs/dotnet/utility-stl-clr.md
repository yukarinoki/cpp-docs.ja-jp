...
`right.`[ペア:: FIRST (STL/clr)](../dotnet/pair-first-stl-clr.md)と `right.` [PAIR:: second (stl/clr)](../dotnet/pair-second-stl-clr.md)を使用して、格納されているペアを初期化します。
