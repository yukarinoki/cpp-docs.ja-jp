...
|[nth_element (STL/CLR)](#nth_element)|`n`要素のシーケンスをパーティション分割します。シーケンスの前にあるすべての要素がそれ以下で、それに続くすべての要素がそれよりも小さいか等しいことを確認します。|
...
|[random_shuffle (STL/CLR)](#random_shuffle)|範囲内の `N` 要素のシーケンスを `N`のいずれかに再配置します。 個の可能な配置の 1 つに再配置します。|
...
この関数は、`adjacent_find`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [adjacent_find](../standard-library/algorithm-functions.md#adjacent_find)」を参照してください。
...
この関数は、`binary_search`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [binary_search](../standard-library/algorithm-functions.md#binary_search)」を参照してください。
...
この関数は、`copy`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [copy](../standard-library/algorithm-functions.md#copy)」を参照してください。
...
この関数は、`copy_backward`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [copy_backward](../standard-library/algorithm-functions.md#copy_backward)」を参照してください。
...
この関数は、`count`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [count](../standard-library/algorithm-functions.md#count)」を参照してください。
...
この関数は、`count_if`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [count_if](../standard-library/algorithm-functions.md#count_if)」を参照してください。
...
この関数は、`equal`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [equal](../standard-library/algorithm-functions.md#equal)」を参照してください。
...
この関数は、`equal_range`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [equal_range](../standard-library/algorithm-functions.md#equal_range)」を参照してください。
...
この関数は、`fill`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [fill](../standard-library/algorithm-functions.md#fill)」を参照してください。
...
この関数は、`fill_n`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [fill_n](../standard-library/algorithm-functions.md#fill_n)」を参照してください。
...
この関数は、`find`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [find](../standard-library/algorithm-functions.md#find)」を参照してください。
...
この関数は、`find_end`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [find_end](../standard-library/algorithm-functions.md#find_end)」を参照してください。
...
この関数は、`find_first_of`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [find_first_of](../standard-library/algorithm-functions.md#find_first_of)」を参照してください。
...
この関数は、`find_if`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [find_if](../standard-library/algorithm-functions.md#find_if)」を参照してください。
...
この関数は、`for_each`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [for_each](../standard-library/algorithm-functions.md#for_each)」を参照してください。
...
この関数は、`generate`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [generate](../standard-library/algorithm-functions.md#generate)」を参照してください。
...
この関数は、`generate_n`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [generate_n](../standard-library/algorithm-functions.md#generate_n)」を参照してください。
...
この関数は、`includes`C++標準ライブラリ関数と同じように動作します。 詳細については、「[インクルード](../standard-library/algorithm-functions.md#includes)」を参照してください。
...
この関数は、 C++標準ライブラリ関数と同じように動作します。詳細については `inplace_merge` 「 [inplace_merge](../standard-library/algorithm-functions.md#inplace_merge)」を参照してください。
...
この関数は、`iter_swap`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [iter_swap](../standard-library/algorithm-functions.md#iter_swap)」を参照してください。
...
この関数は、`lexicographical_compare`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [lexicographical_compare](../standard-library/algorithm-functions.md#lexicographical_compare)」を参照してください。
...
この関数は、`lower_bound`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [lower_bound](../standard-library/algorithm-functions.md#lower_bound)」を参照してください。
...
この関数は、`make_heap`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [make_heap](../standard-library/algorithm-functions.md#make_heap)」を参照してください。
...
この関数は、`max`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [max](../standard-library/algorithm-functions.md#max)」を参照してください。
...
この関数は、`max_element`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [max_element](../standard-library/algorithm-functions.md#max_element)」を参照してください。
...
この関数は、`merge`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [merge](../standard-library/algorithm-functions.md#merge)」を参照してください。
...
この関数は、`min`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [min](../standard-library/algorithm-functions.md#min)」を参照してください。
...
この関数は、`min_element`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [min_element](../standard-library/algorithm-functions.md#min_element)」を参照してください。
...
この関数は、`mismatch`C++標準ライブラリ関数と同じように動作します。 詳細については、「[不一致](../standard-library/algorithm-functions.md#mismatch)」を参照してください。
...
この関数は、`next_permutation`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [next_permutation](../standard-library/algorithm-functions.md#next_permutation)」を参照してください。

## <a name="nth_element-stlclr"></a><a name="nth_element"></a>nth_element (STL/CLR)

要素の範囲をパーティション分割し、その範囲内のシーケンスの `n`th 要素を適切に配置します。これにより、その前にあるすべての要素がそれ以下で、シーケンス内の後続のすべての要素がその値以上になります。
...
この関数は、`nth_element`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [nth_element](../standard-library/algorithm-functions.md#nth_element)」を参照してください。
...
この関数は、`partial_sort`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [partial_sort](../standard-library/algorithm-functions.md#partial_sort)」を参照してください。
...
この関数は、`partial_sort_copy`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [partial_sort_copy](../standard-library/algorithm-functions.md#partial_sort_copy)」を参照してください。
...
この関数は、`partition`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [partition](../standard-library/algorithm-functions.md#partition)」を参照してください。
...
この関数は、`pop_heap`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [pop_heap](../standard-library/algorithm-functions.md#pop_heap)」を参照してください。
...
この関数は、`prev_permutation`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [prev_permutation](../standard-library/algorithm-functions.md#prev_permutation)」を参照してください。
...
この関数は、`push_heap`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [push_heap](../standard-library/algorithm-functions.md#push_heap)」を参照してください。

## <a name="random_shuffle-stlclr"></a><a name="random_shuffle"></a>random_shuffle (STL/CLR)

範囲内の `N` 要素のシーケンスを `N`のいずれかに再配置します。 個の可能な配置の 1 つに再配置します。
...
この関数は、`random_shuffle`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [random_shuffle](../standard-library/algorithm-functions.md#random_shuffle)」を参照してください。
...
この関数は、`remove`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [remove](../standard-library/algorithm-functions.md#remove)」を参照してください。
...
この関数は、`remove_copy`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [remove_copy](../standard-library/algorithm-functions.md#remove_copy)」を参照してください。
...
この関数は、`remove_copy_if`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [remove_copy_if](../standard-library/algorithm-functions.md#remove_copy_if)」を参照してください。
...
この関数は、`remove_if`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [remove_if](../standard-library/algorithm-functions.md#remove_if)」を参照してください。
...
この関数は、`replace`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [replace](../standard-library/algorithm-functions.md#replace)」を参照してください。
...
この関数は、`replace_copy`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [replace_copy](../standard-library/algorithm-functions.md#replace_copy)」を参照してください。
...
この関数は、`replace_copy_if`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [replace_copy_if](../standard-library/algorithm-functions.md#replace_copy_if)」を参照してください。
...
この関数は、`replace_if`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [replace_if](../standard-library/algorithm-functions.md#replace_if)」を参照してください。
...
この関数は、`reverse`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [reverse](../standard-library/algorithm-functions.md#reverse)」を参照してください。
...
この関数は、`reverse_copy`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [reverse_copy](../standard-library/algorithm-functions.md#reverse_copy)」を参照してください。
...
この関数は、`rotate`C++標準ライブラリ関数と同じように動作します。 詳細については、「[回転](../standard-library/algorithm-functions.md#rotate)」を参照してください。
...
この関数は、`rotate_copy`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [rotate_copy](../standard-library/algorithm-functions.md#rotate_copy)」を参照してください。
...
この関数は、`search`C++標準ライブラリ関数と同じように動作します。 詳細については、「[検索](../standard-library/algorithm-functions.md#search)」を参照してください。
...
この関数は、`search_n`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [search_n](../standard-library/algorithm-functions.md#search_n)」を参照してください。
...
この関数は、`set_difference`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [set_difference](../standard-library/algorithm-functions.md#set_difference)」を参照してください。
...
この関数は、`set_intersection`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [set_intersection](../standard-library/algorithm-functions.md#set_intersection)」を参照してください。
...
この関数は、`set_symmetric_difference`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [set_symmetric_difference](../standard-library/algorithm-functions.md#set_symmetric_difference)」を参照してください。
...
この関数は、`set_union`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [set_union](../standard-library/algorithm-functions.md#set_union)」を参照してください。
...
この関数は、`sort`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [sort](../mfc/reference/cmfclistctrl-class.md#sort)」を参照してください。
...
この関数は、`sort_heap`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [sort_heap](../standard-library/algorithm-functions.md#sort_heap)」を参照してください。
...
この関数は、`stable_partition`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [stable_partition](../standard-library/algorithm-functions.md#stable_partition)」を参照してください。
...
この関数は、`stable_sort`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [stable_sort](../standard-library/algorithm-functions.md#stable_sort)」を参照してください。
...
この関数は、`swap`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [swap](../standard-library/algorithm-functions.md#swap)」を参照してください。
...
この関数は、`swap_ranges`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [swap_ranges](../standard-library/algorithm-functions.md#swap_ranges)」を参照してください。
...
この関数は、`transform`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [transform](../standard-library/algorithm-functions.md#transform)」を参照してください。
...
この関数は、`unique`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [unique](../standard-library/algorithm-functions.md#unique)」を参照してください。
...
この関数は、`unique_copy`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [unique_copy](../standard-library/algorithm-functions.md#unique_copy)」を参照してください。
...
この関数は、`upper_bound`C++標準ライブラリ関数と同じように動作します。 詳細については、「 [upper_bound](../standard-library/algorithm-functions.md#upper_bound)」を参照してください。
