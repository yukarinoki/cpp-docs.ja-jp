---
description: '詳細情報: Clang プロジェクトのプロパティ (Android C++)'
...
| プリコンパイル済みヘッダーのコンパイル言語の選択 | プリコンパイル済みヘッダー ファイルのコンパイル言語オプションを選択します (-x c-header、-x c++-header)。 | C コードとして **コンパイル** します。 c コードとしてコンパイルします。<br>C++ コードとして **コンパイル**-c++ コードとしてコンパイルします。<br> |
| コンパイル言語の選択 | とファイルのコンパイル言語オプションを選択し *`.c`* *`.cpp`* ます。  ' Default ' は *`.c`* 、または拡張機能に基づいて検出され *`.cpp`* ます。 (-x c、-x c++) | **既定** - 既定。<br>C コードとして **コンパイル** します。 c コードとしてコンパイルします。<br>C++ コードとして **コンパイル**-c++ コードとしてコンパイルします。<br> |
